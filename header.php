                    ...
                    <div class="card-body">
                        ...
                        <form class="mb-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="modalSignupVerticalEmail"
                                    placeholder="Your email">
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="mb-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="modalSigninVerticalEmail"
                                    placeholder="Your email">
                            </div>
                                    ...
                                    <div class="icon icon-sm text-primary">
                                        ...
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                            ...
                                            <g id="Stockholm-icons-/-General-/-Clipboard" stroke="none" stroke-width="1"
                                                ...
                                                <rect id="Rectangle-152" fill="#335EEA" opacity="0.3" x="7" y="10" width="5"
                                                    height="2" rx="1"></rect>
                                        ...
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                            ...
                                            <g id="Stockholm-icons-/-Files-/-File" stroke="none" stroke-width="1"
                                                ...
                                                <rect id="Rectangle" fill="#335EEA" x="6" y="11" width="9" height="2"
                                                    rx="1"></rect>
                                                <rect id="Rectangle-Copy" fill="#335EEA" x="6" y="15" width="5" height="2"
                                                    rx="1"></rect>
                                            </g>
                                        </svg>
                                    </div>
